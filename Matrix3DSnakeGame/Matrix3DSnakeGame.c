...
static SnakeNode dir_to_delta(SnakeDirection d) {
    switch (d) {
        case DIR_X_POS: return (SnakeNode){ 1, 0, 0 };
        case DIR_X_NEG: return (SnakeNode){-1, 0, 0 };
        case DIR_Y_POS: return (SnakeNode){ 0, 1, 0 };
        case DIR_Y_NEG: return (SnakeNode){ 0,-1, 0 };
        case DIR_Z_POS: return (SnakeNode){ 0, 0, 1 };
        case DIR_Z_NEG: return (SnakeNode){ 0, 0,-1 };
        default:        return (SnakeNode){ 0, 0, 0 };
    }
}
